...
crate::set_circom_circuits! {
    ("age_range_final.zkey", circom_prover::witness::WitnessFn::RustWitness(witness::agerange_witness)),
    ("status_check_final.zkey", circom_prover::witness::WitnessFn::RustWitness(witness::statuscheck_witness)),
    ("nullifier_final.zkey", circom_prover::witness::WitnessFn::RustWitness(witness::nullifier_witness)),
}
